<section class="content-header">
    <h1>
        <?php echo __('Species'); ?>
        <small><?php echo __('Edit Species'); ?></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo __('Edit Species'); ?></li>
    </ol>
</section>
<div class="species form" style="margin: 20px" >
        ...
        <div class="panel panel-default">
            ...
            <div style="margin: 20px">
                <?php
					...
					echo $this->Html->div('row',$this->Form->input('description',array('div'=>'col-xs-5','class'=>'form-control input-sm')),array('escape'=>false));
				?>
