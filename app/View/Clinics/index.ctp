<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo __('Clinics'); ?></li>
    </ol>
</section>
<div class="clinics index" style="margin: 20px" >
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	...
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Clinics', 'action' => 'index');?>
						...
						<tr>
						<td><?php echo h($this->Time->nice($clinic['Clinic']['created'],null,'%d/%m/%Y')); ?>&nbsp;</td>
							<td><?php if($clinic['Clinic']['active'] == 'S'){
						...
						<td><?php echo h($clinic['Clinic']['phone_2']); ?>&nbsp;</td>
						<td><?php echo h($clinic['Clinic']['email']); ?>&nbsp;</td>
							<td class="actions">
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $clinic['Clinic']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $clinic['Clinic']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $clinic['Clinic']['id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $clinic['Clinic']['id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
