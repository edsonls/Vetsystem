<section class="content-header">
    <h1>
        ...
        <small><?php echo __('Add Examination'); ?></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo __('Add Examination'); ?></li>
    </ol>
</section>
<div class="examinations form" style="margin: 20px" >
        ...
        <div class="panel panel-default">
            ...
            <div style="margin: 20px">
                <?php
					...
					//echo $this->Html->div('row',$this->Form->input('Order',array('div'=>'col-xs-5','class'=>'form-control input-sm')),array('escape'=>false));
				?>
