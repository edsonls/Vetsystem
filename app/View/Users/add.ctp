<section class="content-header">
    <h1>
        <?php echo __('Users'); ?>        <small><?php echo __('Add User'); ?></small>
    </h1>
    <ol class="breadcrumb">
...
$options = array('S' => __('Active'),'N' => __('Inactive'));
			...
			echo $this->Html->div('row',$this->Form->input('username',array('div'=>'col-xs-5','class'=>'form-control input-sm')),array('escape'=>false));
			echo $this->Html->div('row',$this->Form->input('password',array('div'=>'col-xs-5','class'=>'form-control input-sm')),array('escape'=>false));
			echo $this->Html->div('row',$this->Form->input('group_id',array('div'=>'col-xs-5','class'=>'form-control input-sm')),array('escape'=>false));
			echo $this->Html->div('row',$this->Form->input('status',array('div'=>'col-xs-5','type'=>'hidden','value'=>'1','class'=>'form-control input-sm')),array('escape'=>false));
			...
			echo $this->Html->div('row',$this->Form->input('image',array('type' => 'file','div'=>'col-xs-5','class'=>'form-control input-sm')),array('escape'=>false));
	?>
