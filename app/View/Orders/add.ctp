...
<section class="content-header">
    <h1>
        <?php echo __('Orders'); ?>
        <small><?php echo __('Add Order'); ?></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="panel panel-default">
            ...
            <div style="margin: 20px">
               <?php
					...
					echo $this->Html->div('row',$this->Form->input('client_id',array('id'=>'client_id','div'=>'col-xs-5','class'=>'form-control input-sm selectpicker','empty' => __('Selecione o Cliente'),'data-style'=>'btn-primary','data-live-search'=>'true')),array('escape'=>false));
					echo $this->Html->div('row',$this->Form->input('animal_id',array('id'=>'animal_id','div'=>'col-xs-5','class'=>'form-control input-sm')),array('escape'=>false));
...
$(document).ready(function () {
	$("#client_id").bind("change", function (event) {
		$.ajax({async:true, data:
			$("#client_id").serialize(), dataType:"html", success:function (data, textStatus) {
				$("#animal_id").html(data);}, type:"post", url:"/Orders/ajax_animal"});
return false;});});
</script>