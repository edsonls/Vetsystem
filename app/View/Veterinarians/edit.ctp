<section class="content-header">
    <h1>
        ...
        <small><?php echo __('Edit Veterinarian'); ?></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo __('Edit Veterinarian'); ?></li>
    </ol>
</section>
<div class="veterinarians form" style="margin: 20px" >
<?php echo $this->Form->create('Veterinarian'); ?>
    <fieldset>
        <div class="panel panel-default">
            ...
            <div style="margin: 20px">
                <?php
					...
					echo $this->Html->div('row',$this->Form->input('crmv',array('div'=>'col-xs-5','class'=>'form-control input-sm')),array('escape'=>false));
