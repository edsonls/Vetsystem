<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo __('Veterinarians'); ?></li>
    </ol>
</section>
<div class="veterinarians index" style="margin: 20px" >
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	<thead>
                	   <tr>
                    	<th><?php echo $this->Paginator->sort(__('created')); ?></th>
                            ...
                            <th><?php echo $this->Paginator->sort(__('crmv')); ?></th>
                	...
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Veterinarians', 'action' => 'index');?>
                            ...
                            <td><?php echo $this->Form->input('crmv', array('label' => '','default' => '','style'=>'width:100%','empty' => __('All crmv')));?></td>
						...
						<tr>
						<td><?php echo h($this->Time->nice($veterinarian['Veterinarian']['created'],null,'%d/%m/%Y')); ?>&nbsp;</td>
							<td><?php if($veterinarian['Veterinarian']['active'] == 'S'){
                              echo '<span  class="btn-sm bg-green pull-right">'.__('Active').'</span>';
                           }else{
                              echo '<span  class="btn-sm bg-red pull-right">'.__('Inactive').'</span>';
                           } ?></td>
						<td><?php echo h($veterinarian['Veterinarian']['name']); ?>&nbsp;</td>
						<td><?php echo h($veterinarian['Veterinarian']['crmv']); ?>&nbsp;</td>
						<td><?php echo h($veterinarian['Veterinarian']['phone']); ?>&nbsp;</td>
						<td><?php echo h($veterinarian['Veterinarian']['phone_2']); ?>&nbsp;</td>
						<td><?php echo h($veterinarian['Veterinarian']['email']); ?>&nbsp;</td>
							<td class="actions">
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $veterinarian['Veterinarian']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $veterinarian['Veterinarian']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $veterinarian['Veterinarian']['id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $veterinarian['Veterinarian']['id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
