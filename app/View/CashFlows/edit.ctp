<section class="content-header">
    <h1>
        ...
        <small><?php echo __('Edit Cash Flow'); ?></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo __('Edit Cash Flow'); ?></li>
    </ol>
</section>
<div class="cashFlows form" style="margin: 20px" >
        ...
        <div class="panel panel-default">
            ...
            <div style="margin: 20px">
                <?php
					...
					echo $this->Html->div('row',$this->Form->input('order_id',array('div'=>'col-xs-5','class'=>'form-control input-sm')),array('escape'=>false));
					echo $this->Html->div('row',$this->Form->input('total',array('div'=>'col-xs-5','class'=>'form-control input-sm')),array('escape'=>false));
				?>
