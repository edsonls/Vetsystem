<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo __('Payment Methods'); ?></li>
    </ol>
</section>
<div class="paymentMethods index" style="margin: 20px" >
        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	...
                	<tbody>
                	    <tr>
                    	    <?php $base_url = array('controller' => 'Payment Methods', 'action' => 'index');?>
						...
						<tr>
							<td><?php if($paymentMethod['PaymentMethod']['active'] == 'S'){
                              echo '<span  class="btn-sm bg-green pull-right">'.__('Active').'</span>';
                           }else{
                              echo '<span  class="btn-sm bg-red pull-right">'.__('Inactive').'</span>';
                           } ?></td>
						<td><?php echo h($this->Time->nice($paymentMethod['PaymentMethod']['created'],null,'%d/%m/%Y')); ?>&nbsp;</td>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $paymentMethod['PaymentMethod']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $paymentMethod['PaymentMethod']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $paymentMethod['PaymentMethod']['id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $paymentMethod['PaymentMethod']['id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
